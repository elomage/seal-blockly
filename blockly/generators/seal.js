 ...
 * @private
 */
Blockly.Seal.RESERVED_WORDS_ =
    // https://developer.mozilla.org/en/Seal/Reference/Reserved_Words
    'break,case,catch,continue,debugger,default,delete,do,else,finally,for,function,if,in,instanceof,new,return,switch,this,throw,try,typeof,var,void,while,with,' +
    'class,enum,export,extends,import,super,implements,interface,let,package,private,protected,public,static,yield,' +
    'const,null,true,false,' +
    // https://developer.mozilla.org/en/Seal/Reference/Global_Objects
  ...
  if (Blockly.Variables) {
    if (!Blockly.Seal.variableDB_) {
      Blockly.Seal.variableDB_ =
          new Blockly.Names(Blockly.Seal.RESERVED_WORDS_.split(','));
    } else {
    ...
    for (var x = 0; x < variables.length; x++) {
      defvars[x] = 'var ' +
          Blockly.Seal.variableDB_.getDistinctName(variables[x],
...
Blockly.Seal.finish = function(code) {
  ...
  for (var name in Blockly.Seal.definitions_) {
    definitions.push(Blockly.Seal.definitions_[name]);
  }
...
/**
 * Encode a string as a properly escaped Seal string, complete with
 * quotes.
